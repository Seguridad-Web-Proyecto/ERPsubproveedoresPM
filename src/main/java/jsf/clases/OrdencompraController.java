...
import beans.sessions.OrdencompraFacade;
...
public class OrdencompraController implements Serializable {
    ...
    @EJB
    private beans.sessions.OrdencompraFacade ejbFacade;
    private List<Ordencompra> items = null;
    ...
    public void setSelected(Ordencompra selected) {
    ...
    public Ordencompra prepareCreate() {
        selected = new Ordencompra();
        initializeEmbeddableKey();
        return selected;
    }

    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("OrdencompraCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("OrdencompraUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("OrdencompraDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<Ordencompra> getItems() {
        if (items == null) {
    ...
    public List<Ordencompra> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<Ordencompra> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
