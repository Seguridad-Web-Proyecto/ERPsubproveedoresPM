...
public class PagoventaJpaController implements Serializable {
    ...
    public void edit(Pagoventa pagoventa) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
            ...
            for (Facturaventa facturaventaCollectionOldFacturaventa : facturaventaCollectionOld) {
                if (!facturaventaCollectionNew.contains(facturaventaCollectionOldFacturaventa)) {
                    facturaventaCollectionOldFacturaventa.setPagoid(null);
    ...
    public void destroy(Long id) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Collection<Facturaventa> facturaventaCollection = pagoventa.getFacturaventaCollection();
            for (Facturaventa facturaventaCollectionFacturaventa : facturaventaCollection) {
                facturaventaCollectionFacturaventa.setPagoid(null);
                facturaventaCollectionFacturaventa = em.merge(facturaventaCollectionFacturaventa);
            }
            em.remove(pagoventa);
            utx.commit();
