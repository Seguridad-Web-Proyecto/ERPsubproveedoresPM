...
public class FacturacompraJpaController implements Serializable {
        ...
        try {
            ...
            for (Ordencompra ordencompraCollectionOldOrdencompra : ordencompraCollectionOld) {
                if (!ordencompraCollectionNew.contains(ordencompraCollectionOldOrdencompra)) {
                    ordencompraCollectionOldOrdencompra.setFacturaid(null);
                    ordencompraCollectionOldOrdencompra = em.merge(ordencompraCollectionOldOrdencompra);
                }
            }
    ...
    public void destroy(Long id) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Collection<Ordencompra> ordencompraCollection = facturacompra.getOrdencompraCollection();
            for (Ordencompra ordencompraCollectionOrdencompra : ordencompraCollection) {
                ordencompraCollectionOrdencompra.setFacturaid(null);
                ordencompraCollectionOrdencompra = em.merge(ordencompraCollectionOrdencompra);
            }
