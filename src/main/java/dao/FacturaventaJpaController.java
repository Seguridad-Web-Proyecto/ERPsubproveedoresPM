...
public class FacturaventaJpaController implements Serializable {
    ...
    public void edit(Facturaventa facturaventa) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
            ...
            for (Ordenventa ordenventaCollectionOldOrdenventa : ordenventaCollectionOld) {
                if (!ordenventaCollectionNew.contains(ordenventaCollectionOldOrdenventa)) {
                    ordenventaCollectionOldOrdenventa.setFacturaid(null);
                    ordenventaCollectionOldOrdenventa = em.merge(ordenventaCollectionOldOrdenventa);
                }
            }
    ...
    public void destroy(Long id) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Collection<Ordenventa> ordenventaCollection = facturaventa.getOrdenventaCollection();
            for (Ordenventa ordenventaCollectionOrdenventa : ordenventaCollection) {
                ordenventaCollectionOrdenventa.setFacturaid(null);
                ordenventaCollectionOrdenventa = em.merge(ordenventaCollectionOrdenventa);
            }
