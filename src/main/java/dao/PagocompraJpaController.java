...
public class PagocompraJpaController implements Serializable {
    ...
    public void edit(Pagocompra pagocompra) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
            ...
            for (Facturacompra facturacompraCollectionOldFacturacompra : facturacompraCollectionOld) {
                if (!facturacompraCollectionNew.contains(facturacompraCollectionOldFacturacompra)) {
                    facturacompraCollectionOldFacturacompra.setPagoid(null);
                    facturacompraCollectionOldFacturacompra = em.merge(facturacompraCollectionOldFacturacompra);
                }
            }
    ...
    public void destroy(Long id) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Collection<Facturacompra> facturacompraCollection = pagocompra.getFacturacompraCollection();
            for (Facturacompra facturacompraCollectionFacturacompra : facturacompraCollection) {
                facturacompraCollectionFacturacompra.setPagoid(null);
                facturacompraCollectionFacturacompra = em.merge(facturacompraCollectionFacturacompra);
            }
